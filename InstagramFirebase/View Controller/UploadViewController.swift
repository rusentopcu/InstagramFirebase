                ...
                if error != nil {
                    ...
                    imageReferance.downloadURL { (url, error) in
                        if error == nil {
                            ...
                            let firestorePost = ["imageURL":imageUrl!,"postedBy": Auth.auth().currentUser!.email!,"postComment":self.textComment.text!,"date": FieldValue.serverTimestamp(),"likes":0] as [String:Any]
